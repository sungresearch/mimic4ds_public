...
2. bootstrap CI of model comparisons 
    - compare domain gen models with 
      ERM models
"""
...
parser.add_argument(
    "--save_path",
    type = str,
    default = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_gen/results",
)
...
if __name__ == "__main__":
    ...
    # During model comparison lambda param was not saved into the df but is
    # part of the filename, and so a bandaid solution here is to extract
    # lambda from the filename
