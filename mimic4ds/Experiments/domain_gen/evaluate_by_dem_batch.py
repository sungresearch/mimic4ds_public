...
# error & output paths
error_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_gen/logs/bootstrap_evaluate_by_dem/error"
output_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_gen/logs/bootstrap_evaluate_by_dem/output"
...
for task in tasks:
    for algo in algos:
        ...
        with open (f"{script_tag}{c}.sh", 'w') as rsh:
                rsh.write(f'''\
#!/bin/bash
#PBS -N DGevalDem{task[:2].upper()}{algo[:3]}
