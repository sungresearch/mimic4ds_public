"""
Generate and submit bash scripts to compared models trained using ERM
...
# error & output paths
error_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_gen/logs/bootstrap_compare_with_baseline/error"
output_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_gen/logs/bootstrap_compare_with_baseline/output"
...
train_methods = ['erm','irm','dro','coral','al_layer']
    ...
    for model in comparison_models:
        for method in train_methods:
            ...
            with open (f"{script_tag}{c}.sh", 'w') as rsh:
                    rsh.write(f'''\
#!/bin/bash
#PBS -N DGcomp{task[:2].upper()}{model}{method[:3].upper()}
