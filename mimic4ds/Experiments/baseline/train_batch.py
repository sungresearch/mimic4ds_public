"""
Generate and submit bash scripts to train model on GPU node
"""
...
# error & output paths
error_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/baseline/logs/train/error"
output_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/baseline/logs/train/output"
...
# Tasks
#------------------------------------------------------------------------
tasks = ['mortality']#['sepsis','invasivevent','longlos', 'mortality']
groups = ['2008 - 2010']#['2008 - 2010', '2011 - 2013', '2014 - 2016', '2017 - 2019']
...
for task in tasks:
    for group in groups:
        ...
        with open (f"{script_tag}{c}.sh", 'w') as rsh:
            rsh.write(f'''\
#!/bin/bash
#PBS -N trainBase{task[:2].upper()}{group[:4]}
