...
under domain adaptation with ERM models")
...
if __name__ == "__main__":
    ...
    fpath_test = os.path.join(
        # ERM models were trained under domain generalization setting
        "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_gen/artifacts",  
        f"analysis_id={args['analysis_id']}",
        "results",
        "pred_probs",
    )
    ...
    df_base = pd.read_csv(f"{fpath_base}/{fname_base}.csv")
