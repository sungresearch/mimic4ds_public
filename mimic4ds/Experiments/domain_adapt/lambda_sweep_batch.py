...
# error & output paths
error_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_adapt/logs/lambda_sweep/error"
output_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_adapt/logs/lambda_sweep/output"
        ...
        for n in Ns:
            for l in range(len(lambdas_coral)):
                ...
                with open (f"{script_tag}{c}.sh", 'w') as rsh:
                    rsh.write(f'''\
#!/bin/bash
#PBS -N ls{task[:2].upper()}{n}{method[:2]}{lambd}
