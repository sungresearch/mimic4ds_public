...
# error & output paths
error_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_adapt/logs/bootstrap_compare_ls/error"
output_path = "/hpf/projects/lsung/projects/public/mimic4ds_public/mimic4ds/Experiments/domain_adapt/logs/bootstrap_compare_ls/output"
            ...
            for method in evaluation_methods:
                for l in range(len(lambdas_coral)):
                    ...
                    with open (f"{script_tag}{c}.sh", 'w') as rsh:
                            rsh.write(f'''\
#!/bin/bash
#PBS -N DAcomp{task[:2].upper()}{algo[:2]}{method[:4].upper()}{n}{lambd}
